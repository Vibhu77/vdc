...
$password='';
$select='dental';
$di='error connecting database';

if(!mysql_connect($con,$user,$password)||!mysql_select_db($select))
{
...
$sql= "INSERT INTO clinic (id,name,email,phone,comment)";
...
$first=$_POST['name'];
    $last=$_POST['email'];
    $phoneva=$_POST['subject'];
    $question=$_POST['message'];




$write=mysql_query("INSERT INTO clin VALUES ('','$first','$last','$phoneva','$question')");
...
<head>
    ...
    <meta name="description" content="Vimal dental clinic is situated in SCO 15, First Floor,, Phase 1 <br>
			        Sahibzada Ajit Singh Nagar,Punjab<br>Pin code 160055">
    <meta name="author" content="Vibhor Sharma">

    <title>Vimal Dental clinic</title>
...
<div id="wrapper">
		...
		<div class="top-area">
			<div class="container">
				<div class="row">
					...
					<!--<p class="bold text-left">Monday - Sunday, 9:30am to 8pm </p>-->
					</div>
					<div class="col-sm-6 col-md-6">
					<p class="bold text-right">Call us now 098151 98002</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="intro-content">
			<div class="container">
				<div class="row">
					...
					<h2 class="h-ultra">Vimal Dental Clinic</h2>
					</div>
					...
					<h4 class="h-light">Provide best quality healthcare for you</h4>
						...
						<ul class="lead-list">
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Get your best smile</strong><br />pre-visualization of dental treatment</span></li>
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>24x7 help support</strong><br />feel free to contact anytime</span></li>
							<li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Only use friendly environment</strong><br />We take care of your future</span></li>
						</ul>
					...
					<div class="col-lg-6">
						...
						<img src="img/dummy/homefront.jpg" class="img-responsive" style="width:300px; height:300px;margin-left:240px;margin-top:89px" />
						</div>
					</div>					
				</div>		
			</div>
				...
				<div class="col-sm-3 col-md-3">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						<div class="box text-center">
							...
							<p>
							Make an Appointment. We know your time is valuable. Our specialists are ready to help at your convenience. 
							</p>
						</div>
					</div>
				</div>
				<div class="col-sm-3 col-md-3">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						<div class="box text-center">
							...
							<h4 class="h-bold">Various facilities</h4>
							<p>
							All types of dentistry support is available here.
							</p>
						</div>
					</div>
				</div>
				<div class="col-sm-3 col-md-3">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						<div class="box text-center">
							...
							<p>
							A help desk specialist is responsible for maintaining customer's relationships with the company, 
							</p>
						</div>
					</div>
				</div>
				<div class="col-sm-3 col-md-3">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						<div class="box text-center">
							...
							<p>
							No need to wait for result.We will supply quick report.
							</p>
						</div>
					</div>
				</div>
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="wow lightSpeedIn" data-wow-delay="0.1s">
										<div class="cta-btn">
										<a href="#contact" class="btn btn-skin btn-lg">Book an appoinment</a>
	...
	<!-- Section: services -->
    <section id="facilities" class="home-section nopadding paddingtop-60">
<br>
	<br>
	<br>
		<div class="container">
        ...
        <div class="row">
			<div class="col-sm-6 col-md-6">
				<div class="wow fadeInUp" data-wow-delay="0.2s">
				<img src="img/dummy/official.jpg" class="img-responsive"  style="height:280px; width:250px;" >
				</div>
            </div>
           	...
           	<div class="col-sm-3 col-md-3 ">
				...
				<div class="data-wow-delay fadeInRight" data-wow-delay="0.4s">
                <div class="service-box">
					<div class="service-icon">
						<span class="fa fa-stethoscope fa-3x"></span> 
					</div>
					<div class="service-desc">
						<h5 class="h-light">General Dentistry</h5>
						<p>Preventive services,Overall Health Concerns</p>
					</div>
                </div>
				</div>
				...
				<div class="service-box">
					...
					<div class="service-desc">
						<h5 class="h-light">Root canal</h5>
						<p>pulp-filled cavity in the root of a tooth.</p>
					</div>
                </div>
				</div>
				...
				<div class="service-box">
					...
					<div class="service-desc">
						<h5 class="h-light">Orthodentist</h5>
						<p>Dentist who specializes in straightening crooked teeth.</p>
					</div>
                </div>
				</div>
			...
			<div class="col-sm-3 col-md-3">
                ...
                <div class="service-box">
					...
					<div class="service-desc">
						<h5 class="h-light">Implants</h5>
						<p>Device manufactured to replace biological structure.</p>
					</div>
                </div>
				</div>
				...
				<div class="service-box">
					...
					<div class="service-desc">
						<h5 class="h-light">Smile design</h5>
						<p> pre-visualization of dental treatment</p>
					</div>
                </div>
				</div>
				<div class="wow fadeInRight" data-wow-delay="0.3s">
...
<!--gallery-->
 <section id="gallery" class="home-section bg-gray paddingbot-60">
<section class="no-padding" id="portfolio">
        <div class="container-fluid">
            <div class="row no-gutter popup-gallery">
                <div class="col-lg-4 col-sm-6">
                    <a href="img/portfolio/fullsize/1.jpg" class="portfolio-box">
                        <img src="img/portfolio/thumbnails/dent1.jpg" class="img-responsive" alt="" >
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="img/portfolio/fullsize/2.jpg" class="portfolio-box">
                        <img src="img/portfolio/thumbnails/dent2.jpg" class="img-responsive" alt="" >
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                   Vimal Dental
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="img/portfolio/fullsize/3.jpg" class="portfolio-box">
                        <img src="img/portfolio/thumbnails/dent3.jpg" class="img-responsive" alt="" >
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Vimal Dental
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="img/portfolio/fullsize/4.jpg" class="portfolio-box">
                        <img src="img/portfolio/thumbnails/dent4.jpg" class="img-responsive" alt="" >
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Vimal Dental
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="img/portfolio/fullsize/5.jpg" class="portfolio-box">
                        <img src="img/portfolio/thumbnails/dent5.jpg" class="img-responsive" alt="" >
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Vimal Dental
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="img/portfolio/fullsize/6.jpg" class="portfolio-box">
                        <img src="img/portfolio/thumbnails/dent6.jpg" class="img-responsive" alt="" >
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    Vimal Dental
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 col-sm-4">
			      <h3>Contact Info</h3>
			      <div class="space"></div>
			      <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>SCO 15, First Floor,, Phase 1 <br>
			        Sahibzada Ajit Singh Nagar,Punjab</p>
			      <div class="space"></div>
			      <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>Pin code:160055</p>
			      <div class="space"></div>
			      <p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>098151 98002</p>
			    </div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-4">
					<div class="wow fadeInDown" data-wow-delay="0.1s">
					<div class="widget">
						<h5>About Vimal Dental clinic</h5>
						<p>
						Vimal dental clinic is situated in SCO 15<br> First Floor, Phase 1 <br>
			        Sahibzada Ajit Singh Nagar,Punjab<br>Pin code 160055<br>Phone no.098151 98002
						</p>
					</div>
					</div>-->
...
<!--
				...
				<div class="col-md-4">
					<div class="wow fadeInDown" data-wow-delay="0.1s">
					<div class="widget">
						<h5>Vimal Dental Clinic</h5>
						<p>
						Here we Provide best quality healthcare for you.We also provide expert dentistry support.
						</p>
						<ul>
							<li>
				...
				<div class=" col-md-4">
					...
					<div class="widget">
						<h5>Our location</h5>
						<p>First Floor, Phase 1 <br>
			        Sahibzada Ajit Singh Nagar,Punjab<br>pin code 160055</p>		
				...
				<div class="col-md-4">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3429.686165827929!2d76.7209773148539!3d30.727221981638994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390fee703a23e42f%3A0x53ea14e857ef8ef1!2sVimal+Dental+Clinic!5e0!3m2!1sen!2sin!4v1492004599436" width="350" height="250" frameborder="0" style="border:0" allowfullscreen></iframe>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<div class="text-left">
					<p>&copy;Copyright Blue Astral All rights reserved.</p>
					</div>
					</div>
				</div>
				<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<div class="text-right">
						<div class="credits">
                            ...
                            -->
                            <a href="#"></a>  <a href="https://bootstrapmade.com/"></a>
                        </div>
					</div>
					</div>
				</div>
